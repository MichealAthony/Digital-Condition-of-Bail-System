 ...
 *
 * Performs manual Dependency Injection (DI) to wire all layers together.
 * In a Spring Boot application, @Bean / @Autowired would handle this;
 * here we do it explicitly to make the OOD relationships visible.
 *
 ...
 *       ↓
 *   BailRecordService     ← orchestrates UC1, uses all services
 *       ↓
 *   BailRecordController  ← MVC layer, catches exceptions
 *       ↓
 *   ConsoleUI             ← simulates officer interactions
 */
