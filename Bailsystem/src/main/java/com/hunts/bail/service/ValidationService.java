 ...
 *  - Single Responsibility : validation logic only — no persistence, no creation.
 *  - Open/Closed Principle : new field validations can be added without
 *    breaking existing checks.
 *  - Stateless (functional-style methods) : safe for shared/singleton use.
 */
